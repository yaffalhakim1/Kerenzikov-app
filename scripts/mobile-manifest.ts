...
//
// Env:
//   WAKU_MOBILE_DOWNLOAD_URL_PREFIX   base URL for the APK link
...
export const defaultMobileDownloadUrlPrefix =
...
/** The APK a version ships, named the same way the desktop artifacts are. */
...
if (import.meta.main) {
  ...
  await writeMobileManifest(
    ...
    versionName,
    process.env.WAKU_MOBILE_DOWNLOAD_URL_PREFIX ?? defaultMobileDownloadUrlPrefix,
    {
